...
public interface Parser {
     ...
     * {@link Parseable}.
     */
    Object END_OF_INPUT = Token.END_OF_INPUT;
     ...
     *
     * <li>A {@link org.jabref.edn.Symbol} for an edn symbol. ('nil',
     ...
     *
     * <li>A {@link org.jabref.edn.Keyword} for an edn keyword, which
     ...
     */
    Object nextValue(Parseable pbr);
    ...
    interface Config {
         ...
         */
        Tag EDN_UUID = newTag("uuid");

        /**
         * This is the {@code #inst} tag specified by edn.
         */
        Tag EDN_INSTANT = newTag("inst");
         ...
         */
        Tag BIG_DECIMAL_TAG = newTag(
                "org.jabref.edn-java", "BigDecimal");
         ...
         * the parser.
         */
        Tag DOUBLE_TAG = newTag(
                "org.jabref.edn-java", "Double");
         ...
         * the parser.
         */
        Tag BIG_INTEGER_TAG = newTag(
                "org.jabref.edn-java", "BigInteger");
         ...
         */
        default boolean unicodeEscapesInStringLiteralsAreAccepted() {
            return true;
        }
        ...
        interface Builder {
             ...
             */
            Builder setListFactory(CollectionBuilder.Factory f);
             ...
             *         previously called on this Builder.
             */
            Builder setVectorFactory(CollectionBuilder.Factory f);
             ...
             *         previously called on this Builder.
             */
            Builder setSetFactory(CollectionBuilder.Factory f);
             ...
             *         previously called on this Builder.
             */
            Builder setMapFactory(CollectionBuilder.Factory f);
             ...
             *         previously called on this Builder.
             */
            Builder putTagHandler(Tag tag, TagHandler handler);
             ...
             * @return this Builder (for method chaining).
             */
            Builder acceptUnicodeEscapesInStringLiterals(boolean acceptUnicodeEscapes);
