...
import static org.jabref.edn.parser.InstantUtils.calendarToString;
import static org.jabref.edn.parser.InstantUtils.dateToString;
import static org.jabref.edn.parser.InstantUtils.makeCalendar;
import static org.jabref.edn.parser.InstantUtils.makeDate;
import static org.jabref.edn.parser.InstantUtils.makeTimestamp;
import static org.jabref.edn.parser.InstantUtils.parse;
import static org.jabref.edn.parser.InstantUtils.parseNanoseconds;
import static org.jabref.edn.parser.InstantUtils.timestampToString;
...
import org.jabref.edn.parser.ParsedInstant;
...
public class InstantUtilsTest {
    ...
    public void testCalendar() {
        testCalendar("1987-01-01T00:00:00.000000000Z", "1987");
        testCalendar("1987-06-05T11:33:02.123000000Z",
                     "1987-06-05T04:03:02.123-07:30");
        testCalendar("1987-06-05T01:03:02.123000000Z",
                     "1987-06-05T04:03:02.123+03:00");
        testCalendar("1986-12-31T21:00:00.000000000Z",
                     "1987+03:00");
    }
    ...
    public void testDate() {
        testDate("1987-01-01T00:00:00.000000000Z",
                 "1987");
        testDate("1986-12-31T21:00:00.000000000Z",
                 "1987+03:00");
        testDate("1987-06-05T10:33:02.123000000Z",
                 "1987-06-05T10:33:02.123456789-00:00");
        testDate("1987-06-05T01:03:02.123000000Z",
    ...
    public void testTimestamp() {
        testTimestamp("1987-01-01T00:00:00.000000000Z",
                      "1987");
        testTimestamp("1986-12-31T21:00:00.000000000Z",
                      "1987+03:00");
        testTimestamp("1987-06-05T10:33:02.123456789Z",
                      "1987-06-05T10:33:02.123456789-00:00");
        testTimestamp("1987-06-05T01:03:02.123456789Z",
                      "1987-06-05T04:03:02.123456789+03:00");
    }
