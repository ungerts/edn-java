...
import org.jabref.edn.protocols.C3;
...
public class C3Test {
    ...
    public void testMroExample4OrderDisagreement() {
        try {
            ...
            assertEquals("Unable to compute a consistent method resolution"
                    + " order for org.jabref.edn.protocols.C3Test$X4$Z.",
                    e.getMessage());
        }
        try {
            ...
            assertEquals(
                    "Unable to compute a consistent method resolution "
                            + "order for org.jabref.edn.protocols.C3Test$X4$Z2 because "
                            + "org.jabref.edn.protocols.C3Test$X4$Z has no consistent "
    ...
    public void objectIsFinalInOrder() {
        assertEquals(
                Arrays.asList(X5.K.class, X5.A.class, Object.class),
    ...
    public void testArrayList() {
        assertEquals(Arrays.asList(ArrayList.class, AbstractList.class,
                AbstractCollection.class, List.class, SequencedCollection.class, Collection.class,
